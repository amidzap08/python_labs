...
## Что такое Node в односвязном списке?
### Node - это базовый строительный блок, элементарная единица, из которой состоит весь связный список. Каждый Node содержит две части:

## 1. Данные (value)
### Хранит полезную информацию (число, строку, объект и т.д.)

### Это "ценность", ради которой создаётся список

## 2. Ссылка на следующий узел (next)
### Указатель/ссылка на следующий Node в цепочке

### Это делает список "связным"
